            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-kim">
                    ...
                    <div class="panel-heading">
                        <h4>Mã giảng viên : ${entry.index }</h4>
                    </div>

                    <div class="panel-body">
                        <form id="form-login" action="suaGVDAO" method="POST" role="form">
                            <div id="errors">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="CMND" value="${entry.CMND }">
                            </div>
                            <div class="form-group">
                                <label for="sdt">SDT</label>
                                <input type="text" class="form-control" name="SDT" value="${entry.SDT }">
                            </div>
