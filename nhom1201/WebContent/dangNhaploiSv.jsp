            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-kim">
                    ...
                    <div class="panel-body">
                        <form id="form-login" action="dangnhapSv" method="POST" role="form">
                           <div id="errors">

                            </div>
                            <div class="form-group">
                                <label for="username">Tên Đăng Nhập</label>
                                <input type="text" class="form-control" name="user" placeholder="Tên đăng nhập từ 8-20 ký tự" pattern="^[a-zA-Z][a-zA-Z0-9_]{8,20}$" required="required" />
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <a href="quenMatKhau.html" class="btn btn-link">Quên mật khẩu?</a>
                                </div>
                                <div class="col-md-4">
                                    <a href="dangKy.jsp" class="btn btn-link">Đăng ký</a>
                                </div>
                            </div>
                        </form>
                    </div>
