	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">Giangvien</a>
			</div>
			<!-- Top Menu Items -->
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					...
					<li><a href="DSCauhoiDAO"><i class="fa fa-fw fa-bars"></i> Danh sách câu hỏi</a></li>
					
					<li><a href="javascript:;" data-toggle="collapse"
						data-target="#demo"><i class="fa fa-fw fa-graduation-cap "></i>
							Kiểm tra <i class="fa fa-fw fa-caret-down"></i></a>
						<ul id="demo" class="collapse">
							<li><a href="DSCauhoiDAO"><i
									class="fa fa-fw fa-bookmark-o "></i> Câu hỏi</a></li>

							<li><a href="DSKythiDAO"><i
									class="fa fa-fw fa-line-chart"></i> Kỳ thi</a></li>
							
						</ul></li>

					<li><a href="#"><i class="fa fa-fw fa-line-chart"></i> Kết
							quả sinh viên</a></li>
					<li><a href="#"><i class="fa fa-fw fa-flag"></i> Thông báo</a>
					</li>
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">The New Future !</h1>
						<ol class="breadcrumb">
							<li class="active"><i class="fa fa-exchange"></i> Thống kê</li>
						</ol>
					</div>
				</div>
				<!-- /.row -->
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="fa fa-bar-chart-o fa-fw"></i> Tổng sinh viên
								</h3>
							</div>
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="fa fa-clock-o fa-fw"></i> Thời khóa biểu
								</h3>
							</div>
							<div class="panel-body">
					...
					<div class="col-lg-4">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="fa fa-list-ul fa-fw"></i> Danh sách lớp
								</h3>
							</div>
							<div class="panel-body">
								<div class="list-group">
					...
					<div class="col-lg-4">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="fa fa-share-square"></i> Kỳ thi
								</h3>
							</div>
							<div class="panel-body">
