...
@WebServlet("/DSKythi_SinhvienDAO")
public class DSKythi_SinhvienDAO extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public DSKythi_SinhvienDAO() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/Ds_KyThi_Sinhvien.jsp").forward(request, response);
	}
